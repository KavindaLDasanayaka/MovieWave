...
import 'package:moviewave/src/movie/data/datasources/movie_remote_data_src_impl.dart';
import 'package:moviewave/src/movie/data/repos/movie_repo_impl.dart';
...
import 'package:moviewave/src/tv_show/data/datasources/tv_show_remote_data_src_impl.dart';
import 'package:moviewave/src/tv_show/data/repos/tv_show__repo_impl.dart';
import 'package:moviewave/src/tv_show/domain/repos/tv_show_repo.dart';
import 'package:moviewave/src/tv_show/domain/usecases/get_popular.dart';
import 'package:moviewave/src/tv_show/domain/usecases/get_top_rated.dart';
